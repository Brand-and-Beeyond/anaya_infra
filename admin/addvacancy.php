                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom01" placeholder="Post Name"  required name="postName">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom02" placeholder="Experience"  required name="experience">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom03" placeholder="No of Vacancies" required name="no_vacancies">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom04" placeholder="Qualification" required name="qualification">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom05" placeholder="Skills Required" required name="skill1">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom05" placeholder="Location" required name="location1">
                            ...
                            <?php if(isset($_REQUEST['e'])){?>
                                        ...
                                        <?php } else {?>
                                        <button type="submit" name="addnewvacancy" class="btn btn-primary"><i class="fa fa-check"></i>&nbsp;Submit</button>
                                        <?php }?>
                        </form>
                    </div>
                </div>
