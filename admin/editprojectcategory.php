        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Edit Project Category</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="validationCustom01">Project Category Name</label>
                                        <input type="text" class="form-control" id="validationCustom01" placeholder="Project Category Name"   name="projectCatName" value="<?php echo $projectCatName;?>">
                                        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="validationCustom05">Project Category Image</label>
                                        <input type="file" class="form-control" id="validationCustom05" placeholder="Image"  name="projectCatImg">
                            ...
                            <?php if(isset($_REQUEST['e'])){?>
                                        ...
                                        <?php } else {?>
                                        <button type="submit" name="editprojectcat" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Update</button>
                                        <?php }?>
                        </form>
                    </div>
                </div>
