...
<section class="contact-banner position-relative">
    <img src="https://touchwoodbliss.com/images/villa-slide/tent-view.jpg" class="img-fluid w-100 object-fit-cover" alt="">
                        ...
                        <div class="my-4 py-2">
                            <div class="phone d-flex flex-row align-items-center gap-4">
                                ...
                                <div class="contact-info">
                                    ...
                                    <span class="contact-content pt-2">+91-9788774532</span>
                                </div>
                            </div>
                        </div>
                        <div class="my-4 py-2">
                            <div class="phone d-flex flex-row align-items-center gap-4 pt-5">
                                ...
                                <div class="contact-info">
                                    ...
                                    <span class="contact-content pt-2">loremipsum111@gmail.com</span>
                                </div>
                            </div>
                        </div>
                        <div class="my-4 py-2">
                        ...
                        <div class="my-4 py-2">
                            <div class="phone d-flex flex-row align-items-center gap-4 pt-5">
                                ...
                                <div class="contact-info">
                                    ...
                                    <div class="pt-2">
                                        <p class="contact-content">Lorem ipsum dolor sit amet consectetur.</p>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-11">
                <div class="row ">
                    ...
                    <div class="col-lg-7">
                        ...
                        <p class="service_content">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam pariatur totam eum distinctio, nihil perspiciatis?</p>
                        <div class="row mt-4">
                            <div class="col-lg-4 mainservice">
                                <h5 class="d-flex flex-row align-items-center gap-3 text-white"><i class="fas fa-circle"></i> Fast delivery</h5>
                            </div>
                            <div class="col-lg-4 mainservice">
                                <h5 class="d-flex flex-row align-items-center gap-3 text-white"><i class="fas fa-circle"></i>Competetive Price</h5>
                            </div>
                            <div class="col-lg-4 mainservice">
                                <h5 class="d-flex flex-row align-items-center gap-3 text-white"><i class="fas fa-circle"></i> Wide Delivery Area</h5>
                            </div>
                            <div class="mt-4 pt-3">
...
<section class="contact_map mt-5 pt-5">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3749.4125335097847!2d73.7771113744526!3d19.99119342260664!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bddeba0e31a96db%3A0x4e1e72844d44da35!2sTouchwood%20World!5e0!3m2!1sen!2sin!4v1726232171131!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</section>
