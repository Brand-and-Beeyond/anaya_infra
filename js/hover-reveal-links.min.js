{
    ...
    class HoverImgFx1 {
        constructor(el) {
            ...
            this.DOM.reveal.innerHTML = `<div class="hover-reveal-inner"><div class="hover-reveal-img" style="background-image:url(${this.DOM.el.dataset.img})"></div></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealInner = this.DOM.reveal.querySelector('.hover-reveal-inner');
            this.DOM.revealInner.style.overflow = 'hidden';
            this.DOM.revealImg = this.DOM.revealInner.querySelector('.hover-reveal-img');
    ...
    class HoverImgFx4 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'hover-reveal';
            this.DOM.reveal.innerHTML = `<div class="hover-reveal-deco"></div><div class="hover-reveal-inner"><div class="hover-reveal-img" style="background-image:url(${this.DOM.el.dataset.img})"></div></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealInner = this.DOM.reveal.querySelector('.hover-reveal-inner');
            this.DOM.revealInner.style.overflow = 'hidden';
            this.DOM.revealDeco = this.DOM.reveal.querySelector('.hover-reveal-deco');
            this.DOM.revealImg = this.DOM.revealInner.querySelector('.hover-reveal-img');
            charming(this.DOM.el);
            this.DOM.letters = Array.from(this.DOM.el.querySelectorAll('span'));
            this.initEvents();
    ...
    class HoverImgFx7 {
        constructor(el) {
            ...
            for (let i = 0; i <= this.totalImages-1; ++i) {
                inner += `<div class="hover-reveal-img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = Array.from(this.DOM.reveal.querySelectorAll('.hover-reveal-img'));
            charming(this.DOM.el);
            this.DOM.letters = Array.from(this.DOM.el.querySelectorAll('span'));
            this.initEvents();
        }
    ...
    class HoverImgFx9 {
        constructor(el) {
            ...
            let inner = '';
            for (let i = 0; i <= this.totalImages-1; ++i) {
                inner += i === this.totalImages-1 ? `<div class="hover-reveal-img" style="position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>` :
                    `<div class="hover-reveal-img" style="filter: hue-rotate(60deg) saturate(5); position: absolute; background-image:url(${this.DOM.el.dataset.img})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = Array.from(this.DOM.reveal.querySelectorAll('.hover-reveal-img'));
    ...
    class HoverImgFx10 {
        constructor(el) {
            ...
            for (let i = 0, len = imgsArr.length; i <= len-1; ++i ) {
                inner += `<div class="hover-reveal-img" style="transform-origin:0% 0%;opacity:0;position:absolute;background-image:url(${imgsArr[i]})"></div>`;
            }
            this.DOM.reveal.innerHTML = inner;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImgs = Array.from(this.DOM.reveal.querySelectorAll('.hover-reveal-img'));
    ...
    class HoverImgFx11 {
        constructor(el) {
            ...
            this.DOM.reveal = document.createElement('div');
            this.DOM.reveal.className = 'hover-reveal';
            this.DOM.reveal.innerHTML = `<div class="hover-reveal-img" style="background-image:url(${this.DOM.el.dataset.img})"></div>`;
            this.DOM.el.appendChild(this.DOM.reveal);
            this.DOM.revealImg = this.DOM.reveal.querySelector('.hover-reveal-img');
