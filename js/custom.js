...
function dsn_slider() {
    var
        ...
        slider_dot = $('.slide-dot-wrap'),
        active2 = slider_dot.find('.active'),
    ...
    dsn_slider_current.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
        ...
        slider_dot.find('.dot').removeClass('active');
    ...
    dsn_slider_current.on('afterChange', function (event, slick, currentSlide) {
        ...
        active2 = slider_dot.find('[data-id="' + CurrentSlideDom.data('id') + '"]');
