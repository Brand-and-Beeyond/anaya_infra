<style>
    ...
    @keyframes truckByeBye {
        ...
        100% {
            ...
            /* Truck moves off-screen to the left */
        }
    }

    #truck {
        animation: truckByeBye 10s linear infinite;
        /* Continuous movement */
    }


    #haste {
        animation: hasteAnimation 8s linear forwards;
    }
    ...
    #logo {
        animation: logoDown 4s linear forwards;
    }

    #truck {
        animation: truckByeBye 10s linear forwards;
    }
...
<svg cache-id="048ed52b3c694cac989b3795a7940b39" id="ewWf8lsoQjL1" xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 210 137" shape-rendering="geometricPrecision"
    ...
    <g>
        <g>
            ...
            <g transform="matrix(.470705 0 0 0.470705-35.3824-37.8476)">
                <path d="M230.718,296.404c0,0-24.529-19.63-40.09-19.63-16.201.001-40.088,19.63-40.088,19.63Z"
            ...
            <g transform="matrix(.470705 0 0 0.470705 49.1608-24.154)">
                <path d="M305.938,309.303c0,0-16.119-12.898-26.344-12.898-10.646.001-26.342,12.898-26.342,12.898Z"
        ...
        <path id="ewWf8lsoQjL11"
            ...
            paint-order="markers stroke fill" fill="none" stroke="#3b3535" stroke-width="1.64969" stroke-linecap="round"
        ...
        <g>
            <g transform="matrix(.415671 0 0 0.415671-157.189 35.0672)">
                <g transform="matrix(1 0 0-1 369.571 151.201)">
                    <path
                        ...
                        paint-order="markers stroke fill" fill="#3b3535" stroke-width="0.79375" stroke-linecap="square"
                        stroke-linejoin="bevel" />
                    <rect width="58.7484" height="21.0327" rx="0" ry="2.722755" transform="translate(55.1907 131.363)"
                        paint-order="markers stroke fill" fill="#3b3535" stroke-width="0.79375" stroke-linecap="square"
                        stroke-linejoin="bevel" />
                </g>
            ...
            <path d="M15.26087,22.775868L32.121015,5.018072L97.098787,23.243061" fill="none" stroke="#3b3535"
                stroke-width="1.5" />
            <path d="M32.121015,5.018072v18.281454h.368222" fill="none" stroke="#3b3535" stroke-width="1.5" />
        </g>
        <path id="haste" d="M95.932905,31.215779v9.1" fill="none" stroke="#3b3535" stroke-width="1.64969" />
        ...
        <g>
            ...
            <g transform="matrix(.415671 0 0 0.415671-301.574 53.1946)">
                <rect width="4.54997" height="71.3852" rx="0" ry="0" transform="translate(752.448 125.964)"
                    fill="#3b3535" stroke-width="0.79375" />
                <g transform="matrix(1.1324 0 0 1.1324 538.151-145.6)">
                    ...
                    <g>
                        ...
                        <g>
                            ...
                            <g>
                                <polygon points="194.679,217.251 198.149,220.723 196.976,223.824 192.54,219.388"
                                    fill="#fff" stroke-width="0.700946" />
                            </g>
                        </g>
                    </g>
...
<script>
   function handleAnimations() {
    ...
    const anchor1 = document.getElementById('ewWf8lsoQjL62');
    const anchor2 = document.getElementById('ewWf8lsoQjL11');
    ...
    haste.offsetHeight;
    anchor1.offsetHeight;
    anchor2.offsetHeight;
    logo.offsetHeight;
    truck.offsetHeight;
